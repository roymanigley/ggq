...
public enum TemplateType {
    JPA_REST(
            ...
            (basePackagePath, entityTemplates) -> {
                ...
                entityTemplates.put("/src/test/java/" + basePackagePath + "/repository/{EntityName}RepositoryTest.java", "xsl/code-gen-java/HIBERNATE_PABACHE_REST/entity/repositoryTest.xsl");
            ...
            (basePackagePath, nonEntityTemplates) -> {
                ...
                nonEntityTemplates.put("/src/main/java/" + basePackagePath + "/web/rest/exceptions/ExceptionDto.java", "xsl/code-gen-java/HIBERNATE_PABACHE_REST/default/exceptionDto.xsl");
